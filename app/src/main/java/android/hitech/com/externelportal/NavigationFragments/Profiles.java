...
public class Profiles extends Fragment implements RecyclerViewOnItemClick  {
    View view;
    RecyclerView rv;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.profiles, container, false);
        return view;
    }
    ...
    public void onStart() {
        super.onStart();
        String address = "http://172.16.0.6:81/api/MobileApp/GetPostedApplyJobList?candidateId=1";
        ...
        rv.setAdapter(new ProfilesAdapter(this,fList));
    }

    @Override
    public void onItemClickListener(View view, int position) {
        Toast.makeText(getContext(), "RecyclerView Item Clicked", Toast.LENGTH_SHORT).show();
    }
}
